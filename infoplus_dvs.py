...
class Wijziging(object):
    ...
    def oorzaak_engels(self):
        ...
        vertalingen = {
            ...
            'door beperkingen op last van de politie': 'restrictions imposed by the police',
            'door beperkingen op last van de brandweer': 'restrictions imposed by the fire brigade',
