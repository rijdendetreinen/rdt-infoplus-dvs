...
class Wijziging:
    ...
    def oorzaak_engels(self):
        ...
        vertalingen = {
            ...
            'overwegstoring': 'level crossing failure',
            ...
            'defect spoor': 'defective rail',
            'een defect spoor': 'defective rail',
            'defect aan het spoor': 'defective rail',
            'een defect aan het spoor': 'defective rail',
